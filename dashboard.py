...
st.divider()
st.subheader("🎟️ Crea una schedina da un unico bookmaker")
st.caption(
...
if not bookmakers:
    ...
    for _, row in matches_df.iterrows():
        ...
        model_probs = {"Home": row["prob_home"], "Draw": row["prob_draw"], "Away": row["prob_away"]}
        # qui mostriamo tutte le selezioni con EV positivo, anche piccolo:
        # per la schedina l'utente sceglie lui quali combinare
